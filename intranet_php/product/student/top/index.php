                    ...
                    if (($before_data == $row['対象'] && $month >= "03") || ($data == $row['対象'] && $month <= "02")) { ?>
                        <div id=<?php echo $id; ?> class="job_goo">
                            <div class="job_main">
                                ...
                                <i id="favorite<?php echo $id; ?>" class="fas fa-star"
                                    onclick="asyncSend(<?php echo $id; ?>),color(<?php echo $id; ?>)"></i>
                                ...
                                <div class="job_posting">
                                    ...
                                    if (isset($row['参考書類'])) {
                                        ...
                                        print '<a href=job/help-wanted/' . $refer_doc[0] . 'target="_blank">求人票PDF</a>';
                                        ?>
                                    </div>
                                    <div class="job_pamphlet">
                                        <?php if (isset($refer_doc[1]))
                                            print '<a href=job/kigyou_panhu/' . $refer_doc[1] . ' target="_blank">パンフレット</a>';?>
                                    </div>
                              <?php } ?>
