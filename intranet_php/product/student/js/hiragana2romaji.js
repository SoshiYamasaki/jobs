 ...
 * @return {string} ローマ字
 */
function hiragana2romaji()
{
	var textbox_element = document.getElementById('hennkan');
	var hiragana = document.getElementById("henkan").value;
	let romaji = "";
	let index = 0;
...
convert:
	...
	new_element.textContent = romaji;
