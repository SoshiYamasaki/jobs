    ...
    <div class="theme-container grow">
        ...
        <div class="contact-con">
            ...
            <div class="contact">
                ...
                <form action="seitotouroku_check.php" class="form_log" autocomplete="off" method="post">
                ...
                <div class="block"><a href="syokutouroku.php">教職員登録のフォームはこちら</a>
                    <p><br></p>
                </div>
